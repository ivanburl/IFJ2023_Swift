...
Error ifj_2023_parser_config(Parser *parser) {
  ...
  GrammarRule llGrammarRules[] = {
      ...
      grammar_rule_create(S, NULL, NULL, NULL, (TokenType[]){WHILE, COND, BLOCK}, 3),
      grammar_rule_create(S, NULL, NULL, NULL,
      ...
      grammar_rule_create(S, NULL, NULL, NULL, (TokenType[]){RETURN, E}, 2),
      grammar_rule_create(S, NULL, NULL, NULL, (TokenType[]){CONTINUE}, 1),
      grammar_rule_create(S, NULL, NULL, NULL, (TokenType[]){BREAK}, 1),
      grammar_rule_create(COND, NULL, NULL, NULL, (TokenType[]){E}, 1),
      grammar_rule_create(COND, NULL, NULL, NULL, (TokenType[]){LET, ID}, 2),
      grammar_rule_create(IF_ELSE, NULL, NULL, NULL, (TokenType[]){}, 0),
      grammar_rule_create(IF_ELSE, NULL, NULL, NULL, (TokenType[]){ELSE, BLOCK}, 2),
      grammar_rule_create(
      ...
      grammar_rule_create(INIT, NULL, NULL, NULL, (TokenType[]){ASSIGN, E}, 2),
      ...
      grammar_rule_create(F, NULL, NULL, NULL, (TokenType[]){INTEGER}, 1),
      grammar_rule_create(F, NULL, NULL, NULL, (TokenType[]){STRING}, 1),
      grammar_rule_create(F, NULL, NULL, NULL, (TokenType[]){DOUBLE}, 1),
      grammar_rule_create(F, NULL, NULL, NULL, (TokenType[]){BOOLEAN}, 1),
      grammar_rule_create(F, NULL, NULL, NULL, (TokenType[]){HARD_UNWRAP, F}, 2),
      ...
      grammar_rule_create(ARG, NULL, NULL, NULL, (TokenType[]){E, ARG_TMP}, 2),
      ...
      grammar_rule_create(TYPE, NULL, NULL, NULL, (TokenType[]){DOUBLE_NULLABLE_TYPE},
                          1),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){F}, 1),
      // TODO BOOLEAN
  ...
  GrammarRule pGrammarRules[] = {
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, PLUS, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, MINUS, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, MULTIPLY, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, DIVIDE, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, EQUAL, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, NOT_EQUAL, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, GREATER, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, LESS, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, GREATER_EQUAL, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, LESS_EQUAL, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, SOFT_UNWRAP, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, LOGICAL_OR, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){E, LOGICAL_AND, E}, 3),
      grammar_rule_create(E, NULL, NULL, NULL, (TokenType[]){F}, 1),
  };
