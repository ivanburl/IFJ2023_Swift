...
#include "../automata_test/automata_test.h"
...
int test_unite() {
  ...
  TokenType expectedTypes[] = {IF, BLANK,LEFT_BRACKET, ID,BLANK, GREATER, BLANK,
INTEGER, RIGHT_BRACKET, BLANK, LEFT_CURL_BRACKET, ID, LEFT_BRACKET,STRING,
RIGHT_BRACKET, RIGHT_CURL_BRACKET}; size_t expectedLength =
